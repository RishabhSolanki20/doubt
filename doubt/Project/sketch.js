...
function setup() {
 ...
 // World.add(world, tower);
  ...
  ene1 = createSprite(1130,150,20,20)
  ene1.addImage(ene1Img)
  ene1.scale = 0.5
  
  ene2 = createSprite(980,150,20,20)
  ene2.addImage(ene2Img)
  ene2.scale = 0.5

  ene3 = createSprite(850,165,20,20)
  ene3.addImage(ene3Img)
  ene3.scale = 0.6
...
function collision(index) {
    ...
    if (balls[index] !== undefined && ene3 !== undefined) {
      var collision = Matter.SAT.collides(balls[index].body, ene3);
